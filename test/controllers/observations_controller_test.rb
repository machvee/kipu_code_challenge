...
class ObservationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create observation" do
    assert_difference('Observation.count') do
      post observations_url, params: { observation: { admission_id: @observation.admission_id, description: @observation.description, moment: @observation.moment } }
    end
  ...
  test "should update observation" do
    patch observation_url(@observation), params: { observation: { admission_id: @observation.admission_id, description: @observation.description, moment: @observation.moment } }
