...
class SymptomsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create symptom" do
    assert_difference('Symptom.count') do
      post symptoms_url, params: { symptom: { admission_id: @symptom.admission_id, description: @symptom.description } }
    end
  ...
  test "should update symptom" do
    patch symptom_url(@symptom), params: { symptom: { admission_id: @symptom.admission_id, description: @symptom.description } }
