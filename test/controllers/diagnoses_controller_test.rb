...
class DiagnosesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create diagnosis" do
    assert_difference('Diagnosis.count') do
      post diagnoses_url, params: { diagnosis: { admission_id: @diagnosis.admission_id, code: @diagnosis.code, coding_system: @diagnosis.coding_system, description: @diagnosis.description } }
    end
  ...
  test "should update diagnosis" do
    patch diagnosis_url(@diagnosis), params: { diagnosis: { admission_id: @diagnosis.admission_id, code: @diagnosis.code, coding_system: @diagnosis.coding_system, description: @diagnosis.description } }
